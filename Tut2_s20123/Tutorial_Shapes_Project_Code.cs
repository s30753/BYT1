...
namespace Tut2_s20123
{
    ...
    {
        private readonly double side = side <= 0 ? throw new ArgumentException("The value must be positive") : side;
...
namespace Tut2_s20123
{
    ...
    {
        private readonly double length = length <= 0 ? throw new ArgumentException("The value must be positive") : length;
        private readonly double width = width <= 0 ? throw new ArgumentException("The value must be positive") : width;
...
namespace Tut2_s20123
{
    ...
    {
        private readonly double radius = radius <= 0 ? throw new ArgumentException("The value must be positive") : radius;
        private readonly double height = height <= 0 ? throw new ArgumentException("The value must be positive") : height;
